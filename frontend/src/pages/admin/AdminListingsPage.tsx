...
import {
  getAdminListings, approveListing, rejectListing,
...
function ListingCard({ listing, onChanged }: { listing: AdminListing; onChanged: (l: AdminListing) => void }) {
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {listings.map(l => <ListingCard key={l.id} listing={l} onChanged={handleChanged} />)}
          </div>
        )}
      </div>
    </div>
